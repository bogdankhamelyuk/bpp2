...
class Parameters(object):
    ...
    _file = open("/home/bogdan/Vs-code-workspace/python/lndf_video/gui/datafile.json","r")
    _angle = .0
    if os.path.getsize("/home/bogdan/Vs-code-workspace/python/lndf_video/gui/datafile.json") > 0:
        print("is not empty")
